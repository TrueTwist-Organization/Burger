...
<body style="background-color: #FFF8E1;">
    ...
    <div style="max-width: 800px; margin: 150px auto 100px auto; padding: 40px; background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
        <h1 style="color: #D32F2F; font-family: 'Playfair Display', serif; margin-bottom: 30px;">Refund Policy</h1>
        <div style="font-size: 1.1rem; color: #5D4037; line-height: 1.8;">
            <p>At The Perfect Burger, we strive to serve you the freshest and most delicious meals. If you are not entirely satisfied with your order, we're here to help.</p>
            ...
            <p>If you have any questions about our refund policy, please feel free to <a href="index.php#contact" style="color: #E85A1F;">contact us</a>.</p>
